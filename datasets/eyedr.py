...
NEW_CNAMES = {
    "Mild non-proliferative diabetic retinopathy":"Mild non-proliferative diabetic retinopathy",
    "Moderate non-proliferative diabetic retinopathy":"Moderate non-proliferative diabetic retinopathy",
    ...
    "Severe non-proliferative diabetic retinopathy":"Severe non-proliferative diabetic retinopathy",
}


@DATASET_REGISTRY.register()
class EyeDR(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_eyedr.json")
