...
class SimpleTrainer(TrainerBase):
    """A simple trainers class implementing generic functions."""
    ...
    def check_cfg(self, cfg):
        ...
        the trainers (optional).

        For example, a trainers might require a particular sampler
...
class TrainerXU(SimpleTrainer):
    """A base trainers using both labeled and unlabeled data.
...
class TrainerX(SimpleTrainer):
    """A base trainers using labeled data only."""
